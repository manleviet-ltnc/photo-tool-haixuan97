...
namespace Myphotos
{
    public partial class MainForm : Form
    {
        ...
        private void SetStausStrip(string path)
        {
        ...
        private void ctxMenuPhoto_Opening(object sender, CancelEventArgs e)
        {
            ...
            previousToolStripMenuItem.Enabled = (Manager.Index > 0);
        }
    }
}
